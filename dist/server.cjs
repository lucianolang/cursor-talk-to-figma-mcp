...
server.registerTool(
  "list_variables",
  {
    ...
    outputSchema: {
      ...
      variables: import_zod.z.array(import_zod.z.unknown()),
...
server.registerTool(
  "find_variable_usages",
  {
    ...
    outputSchema: {
      success: import_zod.z.boolean(),
      usageSummary: import_zod.z.unknown().nullable(),
      error: import_zod.z.string().optional()
    }
  },
...
server.registerTool(
  "find_broken_variable_aliases",
  {
    ...
    inputSchema: {
      collectionId: import_zod.z.string().describe("The collection ID to inspect")
    },
    outputSchema: {
      success: import_zod.z.boolean(),
      brokenAliases: import_zod.z.array(import_zod.z.unknown()),
      brokenCount: import_zod.z.number(),
      error: import_zod.z.string().optional()
    }
  },
  async ({ collectionId }) => {
...
server.registerTool(
  "get_node_variables",
  {
    ...
    outputSchema: {
      success: import_zod.z.boolean(),
      nodeVariables: import_zod.z.unknown().nullable(),
      error: import_zod.z.string().optional()
    }
  },
  async ({ nodeId }) => {
...
server.tool(
  ...
  {
    variableIds: import_zod.z.array(import_zod.z.string()).min(1).describe("The IDs of the variables to delete")
  },
  async ({ variableIds }) => {
    try {
